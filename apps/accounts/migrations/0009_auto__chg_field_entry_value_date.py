...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry.value_date'
        db.alter_column('accounts_entry', 'value_date', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Entry.value_date'
        db.alter_column('accounts_entry', 'value_date', self.gf('django.db.models.fields.DateField')())
