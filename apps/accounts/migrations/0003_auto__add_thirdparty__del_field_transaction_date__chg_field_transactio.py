...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_thirdparty', (
            ...
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='thirdparties', null=True, to=orm['accounts.Tag'])),
        ))
        ...
        db.add_column('accounts_tag', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tags', null=True, to=orm['auth.User']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('accounts_transaction', 'date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2010, 11, 6)), keep_default=False)

        # Changing field 'Transaction.description'
        db.alter_column('accounts_transaction', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Deleting field 'Entry.third_party'
