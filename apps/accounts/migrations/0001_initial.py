...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_account', (
            ...
            ('initial_amount', self.gf('django.db.models.fields.FloatField')(default=0.0)),
    ...
    models = {
        ...
        'accounts.transaction': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'transactions'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['accounts.Tag']"})
        },
        'auth.group': {
